  ...
  return (
    <div className="min-h-screen bg-[#0d1117] flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 md:px-8 py-6 space-y-4">
        {/* Header Bar */}
        <div className="flex flex-wrap items-center justify-between gap-4 p-3 bg-[#161b22] border border-[#30363d] rounded-xl text-xs">
          <div className="flex items-center gap-2 font-mono">
            <span className="px-2 py-0.5 bg-[#21262d] rounded text-cyan-400 flex items-center gap-1">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleCopy}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#21262d] hover:bg-[#30363d] text-[#c9d1d9] hover:text-white rounded-md transition-colors"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 font-semibold text-white rounded-md transition-colors shadow-md shadow-indigo-600/20"
            >
        ...
        {/* Code Canvas */}
        <div className="border border-[#30363d] rounded-xl overflow-hidden bg-[#090d13]">
          ...
          <div className="flex overflow-x-auto font-mono text-xs py-3">
            {/* Line numbers */}
            <div className="select-none text-right pr-4 pl-3 text-[#484f58] border-r border-[#21262d] leading-6">
              {lines.map((_, idx) => (
            ...
            {/* Code Lines */}
            <div className="flex-1 pl-4 leading-6 text-[#f0f6fc] whitespace-pre">
              {lines.map((line, idx) => (
                <div key={idx} className="hover:bg-[#161b22]/70 transition-colors">
                  {line || ' '}
                </div>
              ))}
            </div>
